...
pkgbase=java-openjdk17
pkgname=('jre-openjdk17-headless' 'jre-openjdk17' 'jdk-openjdk17' 'openjdk17-src' 'openjdk17-doc')
_majorver=17
_updatever=26
pkgrel=1
pkgver=${_majorver}+${_updatever}
arch=('x86_64')
...
source=(https://github.com/openjdk/jdk${_majorver}/archive/refs/tags/jdk-${_majorver}+${_updatever}.tar.gz
        freedesktop-java.desktop
        freedesktop-jconsole.desktop
        freedesktop-jshell.desktop
        zListInline.patch)
sha256sums=('1daa705b4b95f9eb49a321867d7f0d8462d835d926d1a517cbb18d346447e420'
            '8d25558ed4fc31a2aed6abe9f289510b271326c64e8c13972f91b0166b151c81'
...
_jdkdir=jdk${_majorver}-jdk-${_majorver}-${_updatever}
...
package_jre-openjdk17-headless() {
